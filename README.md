...
|                      | No Host Platform                      | Whether to prevent editor platform compilation on the host.                                                                                                                                                                                                                                    |
|                      | Host Platforms                        | Specifies the host platforms to build the plugin.                                                                                                                                                                                                                                              |
...
|                      | Unversioned                           | Whether to embed the engine version to be built into the uplugin file.                                                                                                                                                                                                                         |
